<template>
  ...
  >
    <div class="mx-auto max-w-7xl px-8 py-10">
      <!-- Header Banner -->
      <div
        class="relative overflow-hidden rounded-3xl bg-gradient-to-br from-[#002147] via-[#004595] to-[#00397a] p-10 shadow-2xl hover:shadow-3xl transition-all duration-300 transform hover:scale-[1.01] mb-8"
      >
        <div
          ...
          <div class="relative z-10">
            ...
            <div v-if="categorySearchQuery.trim()" class="space-y-4">
              ...
              >
                ...
                <div class="relative z-10 p-4 space-y-3 max-h-96 overflow-y-auto">
                  <div class="space-y-2">
                    <div
                      v-for="(brgy, idx) in categorySearchResults.barangays"
                      :key="idx"
                      @click="goToBarangay(brgy.name)"
                      class="p-4 bg-white dark:bg-gray-700 rounded-lg border border-[#004595]/10 dark:border-gray-600 hover:border-[#004595] dark:hover:border-blue-400 transition-all group cursor-pointer hover:shadow-md"
                    >
                      <div class="flex items-center justify-between">
                        <div class="flex-1">
                          <div class="flex items-center gap-2 mb-1">
                            ...
                            <h5 class="font-bold text-[#002147] dark:text-white text-sm">
                              {{ brgy.name }}
                            </h5>
                          </div>
                        ...
                        <span
                          class="inline-flex items-center px-3 py-1 rounded-full text-sm font-bold bg-[#004595]/20 dark:bg-blue-500/30 text-[#004595] dark:text-blue-300 group-hover:bg-[#004595] group-hover:text-white dark:group-hover:bg-blue-500 transition-all"
                        >
                          {{ brgy.count }}
                        </span>
                      </div>
            ...
            <div v-else class="text-center py-8">
              ...
              <p class="font-semibold text-[#002147] dark:text-white">
                Search category for all barangay
              </p>
      ...
      <div
        ...
        class="bg-gradient-to-br from-white to-[#f3f1ee]/30 dark:from-gray-800 dark:to-gray-900 rounded-2xl shadow-xl p-20 text-center border border-[#004595]/10 dark:border-gray-700"
      >
        <div class="flex flex-col items-center gap-4">
      ...
      <div v-else class="space-y-4">
        ...
        >
          <div class="p-6">
            <!-- Header Section -->
            <div
              class="flex items-start justify-between mb-6 pb-5 border-b border-gray-200 dark:border-gray-700"
            >
              <div class="flex items-center gap-4">
                <div
                  class="flex items-center justify-center w-12 h-12 rounded-xl bg-gradient-to-br from-[#004595] to-[#00397a] text-white font-bold text-lg shadow-lg"
                >
                  {{ index + 1 }}
                </div>
                <div>
                  <h3 class="text-2xl font-bold text-[#002147] dark:text-white mb-1">
                    {{ record.brgyname || 'N/A' }}
                  </h3>
                  <div class="flex items-center gap-2">
                    <span
                      class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-blue-100 dark:bg-blue-900/50 text-blue-800 dark:text-blue-200"
                    >
                    ...
                    <span
                      v-if="record.date"
                      class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-purple-100 dark:bg-purple-900/50 text-purple-800 dark:text-purple-200"
                    >
                      <svg class="w-3 h-3 mr-1" fill="currentColor" viewBox="0 0 20 20">
                        <path
                          fill-rule="evenodd"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <!-- Captain Info -->
              <div
                class="bg-gradient-to-br from-[#004595]/5 to-transparent dark:from-blue-500/10 dark:to-transparent rounded-xl p-4 border border-[#004595]/10 dark:border-gray-700"
              >
                <div class="flex items-center gap-2 mb-2">
                ...
                <p class="text-base font-bold text-[#002147] dark:text-white truncate">
                  {{ record.cptfullname || 'Not assigned' }}
                </p>
              </div>

              <!-- Members Info with Positions -->
              <div
                class="bg-gradient-to-br from-green-50 to-transparent dark:from-green-900/20 dark:to-transparent rounded-xl p-4 border border-green-200/50 dark:border-green-800/50 col-span-2"
              >
                <div class="flex items-center gap-2 mb-2">
                ...
                <p v-else class="text-base font-bold text-green-800 dark:text-green-300">
                  No members listed
                </p>
              </div>
              ...
              <!-- Patron Info -->
              <div
                class="bg-gradient-to-br from-amber-50 to-transparent dark:from-amber-900/20 dark:to-transparent rounded-xl p-4 border border-amber-200/50 dark:border-amber-800/50"
              >
                <div class="flex items-center gap-2 mb-2">
                ...
                <p class="text-base font-bold text-amber-800 dark:text-amber-300 truncate">
              ...
              <!-- Schools Info -->
              <div
                class="bg-gradient-to-br from-indigo-50 to-transparent dark:from-indigo-900/20 dark:to-transparent rounded-xl p-4 border border-indigo-200/50 dark:border-indigo-800/50"
              >
                <div class="flex items-center gap-2 mb-2">
                ...
                <p class="text-base font-bold text-indigo-800 dark:text-indigo-300 truncate">
                  {{ record.schoolname || 'No schools listed' }}
                </p>
              </div>

              <!-- Churches Info -->
              <div
                class="bg-gradient-to-br from-rose-50 to-transparent dark:from-rose-900/20 dark:to-transparent rounded-xl p-4 border border-rose-200/50 dark:border-rose-800/50"
              >
                <div class="flex items-center gap-2 mb-2">
                ...
                <p class="text-base font-bold text-rose-800 dark:text-rose-300 truncate">
                  {{ record.churchname || 'No churches listed' }}
                </p>
              </div>

              <!-- Establishments Info -->
              <div
                class="bg-gradient-to-br from-cyan-50 to-transparent dark:from-cyan-900/20 dark:to-transparent rounded-xl p-4 border border-cyan-200/50 dark:border-cyan-800/50"
              >
                <div class="flex items-center gap-2 mb-2">
                ...
                <p class="text-base font-bold text-cyan-800 dark:text-cyan-300 truncate">
                  {{ record.establishmentname || 'No establishments listed' }}
                </p>
              </div>
            </div>
          </div>
    ...
    >
      ...
      >
        <div
          class="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-hidden transform transition-all flex flex-col"
        >
          <!-- Modal Header -->
          <div
            class="bg-gradient-to-r from-[#002147] via-[#00397a] to-[#004595] px-6 py-5 relative overflow-hidden flex-shrink-0"
          >
            <div
          ...
          <!-- Modal Body -->
          <div
            class="overflow-y-auto flex-1 p-6 bg-gradient-to-br from-[#f3f1ee]/30 to-white dark:from-gray-800 dark:to-gray-900"
          >
            <div class="space-y-6">
              ...
              >
                <div
                  class="bg-gradient-to-r from-[#004595]/10 to-transparent dark:from-blue-500/20 dark:to-transparent px-5 py-3 border-b border-[#004595]/10 dark:border-gray-600"
                >
                  <h3
                    class="text-lg font-bold text-[#002147] dark:text-white flex items-center gap-2"
                  >
                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                      <path
                        fill-rule="evenodd"
              ...
              >
                ...
                <div class="p-5 space-y-4">
                  <div
                    class="bg-gradient-to-r from-[#004595]/5 to-transparent dark:from-blue-500/10 dark:to-transparent rounded-lg p-4 border border-[#004595]/10 dark:border-blue-800/30"
                  >
                    <p
                  ...
                  <div
                    class="bg-gradient-to-r from-green-50 to-transparent dark:from-green-900/20 dark:to-transparent rounded-lg p-4 border border-green-200 dark:border-green-800/50"
                  >
                    <p
              ...
              >
                ...
                <div class="p-5 grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div
                    class="bg-gradient-to-br from-indigo-50 to-transparent dark:from-indigo-900/20 dark:to-transparent rounded-lg p-4 border border-indigo-200 dark:border-indigo-800/50"
                  >
                    <div class="flex items-center gap-2 mb-2">
                      <div class="p-2 bg-indigo-600 dark:bg-indigo-700 rounded-lg">
                        <svg class="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <div
                    class="bg-gradient-to-br from-rose-50 to-transparent dark:from-rose-900/20 dark:to-transparent rounded-lg p-4 border border-rose-200 dark:border-rose-800/50"
                  >
                    <div class="flex items-center gap-2 mb-2">
                      <div class="p-2 bg-rose-600 dark:bg-rose-700 rounded-lg">
                        <svg class="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <div
                    class="bg-gradient-to-br from-cyan-50 to-transparent dark:from-cyan-900/20 dark:to-transparent rounded-lg p-4 border border-cyan-200 dark:border-cyan-800/50"
                  >
                    <div class="flex items-center gap-2 mb-2">
                      <div class="p-2 bg-cyan-600 dark:bg-cyan-700 rounded-lg">
                        <svg class="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 20 20">
          ...
          <!-- Modal Footer -->
          <div
            class="bg-gray-50 dark:bg-gray-900 px-6 py-4 border-t border-gray-200 dark:border-gray-700 flex justify-end gap-3 flex-shrink-0"
          >
            <button
              @click="closeDetailsModal"
