<template>
  ...
  >
      ...
      >
        <div class="p-6 space-y-6">
          ...
          >
            ...
            ></div>
            <div
              class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-[#004595]/20 rounded-full blur-3xl"
            ></div>

            <div class="relative flex flex-col items-center text-center gap-4">
              <div
                class="h-28 w-28 rounded-full bg-white/20 backdrop-blur-sm overflow-hidden flex items-center justify-center ring-4 ring-white/40 shadow-2xl"
              >
                <img
              ...
              <div>
                <p class="text-xl font-bold leading-tight tracking-wide">
                  {{ captainInfo.name || 'No name' }}
                </p>
          ...
          <section v-if="communityInfo" class="space-y-6">
                    ...
                    <div class="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p class="text-xs text-white/80 font-medium">
                          Quick overview of barangay data
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    >
                      ...
                      <div class="relative">
                        ...
                        <h3 class="text-sm font-bold text-[#002147] uppercase tracking-wider mb-1">
                          Barangay Officers
                        </h3>
                ...
                <div class="p-6 bg-linear-to-br from-white to-[#f3f1ee]/30">
                  ...
                  <div class="flex justify-center mb-6">
                    <div class="relative group">
                      <div
                        class="w-32 h-32 rounded-2xl overflow-hidden border-4 border-[#004595]/20 shadow-lg relative"
                      >
                        <img
                          v-if="captainInfo.profileImage"
                          :src="captainInfo.profileImage"
                  ...
                  <div v-if="!isEditing" class="grid md:grid-cols-2 gap-4">
                    ...
                    >
                      ...
                      <div>
                        ...
                        <p class="font-semibold text-[#002147]">
                          {{ captainInfo.name || 'Not available' }}
                        </p>
                      </div>
                    </div>
                    <div
                    ...
                    >
                      ...
                      <div>
                        <p class="text-xs text-[#00397a] font-bold uppercase tracking-wide">
                          Phone
                        </p>
                        <p class="font-semibold text-[#002147]">
                          {{ captainInfo.phone || 'Not available' }}
                        </p>
                      </div>
                    </div>
                    <div
                    ...
                    >
                      ...
                      <div>
                        ...
                        <p class="font-semibold text-[#002147] text-sm break-all">
                          {{ captainInfo.email || 'Not available' }}
                        </p>
                      </div>
                    </div>
                    <div
                    ...
                    >
                      ...
                      <div>
                        ...
                        <p class="font-semibold text-[#002147]">
                          {{ captainInfo.officeHours || 'Not available' }}
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div v-else class="space-y-4">
                    ...
                    <div class="grid md:grid-cols-2 gap-4">
                      <div>
                        <label class="block text-sm font-bold text-[#002147] mb-2"
                          >Phone Number</label
                        >
                        <input
            ...
            >
              ...
              <div class="relative z-10">
                <div class="flex items-center gap-4 mb-4">
                  ...
                  <div>
                    <h1 class="text-5xl font-black text-white tracking-tight">
                      {{ communityInfo.name }} Butuan City, Agusan Del Norte 8600
                    </h1>
                ...
                <p v-else class="text-lg text-blue-100 font-medium pl-1">
                  Discover our vibrant barangay community
                </p>
              </div>
            </div>
            ...
            <div
              v-if="activeTab === 'overview'"
              class="bg-white rounded-3xl shadow-2xl overflow-hidden border border-gray-100 hover:shadow-3xl transition-all duration-300"
            >
            ...
            <div v-if="activeTab === 'officers'" class="space-y-6">
                ...
                >
                  ...
                  <div class="relative flex items-center justify-between flex-wrap gap-4">
                    <div class="flex items-center gap-4">
                      <div
                        class="p-3 bg-white/20 backdrop-blur-sm rounded-2xl ring-4 ring-white/20"
                      >
                        <svg class="w-8 h-8 text-white" fill="currentColor" viewBox="0 0 20 20">
                          <path
                            d="M9 6a3 3 0 11-6 0 3 3 0 016 0zM17 6a3 3 0 11-6 0 3 3 0 016 0zM12.93 17c.046-.327.07-.66.07-1a6.97 6.97 0 00-1.5-4.33A5 5 0 0119 16v1h-6.07zM6 11a5 5 0 015 5v1H1v-1a5 5 0 015-5z"
                      ...
                      <div>
                        ...
                        <p class="text-white/90 text-sm font-medium mt-1">
                          Community Officers & Leaders Directory
                        </p>
                      </div>
                    </div>
                  ...
                  <div class="relative mt-6 grid grid-cols-2 gap-4">
                    <div
                      class="bg-white/10 backdrop-blur-sm rounded-xl px-4 py-3 border border-white/20"
                    >
                      <div class="flex items-center justify-between">
                        <div>
              ...
              >
                ...
                <p class="text-[#00397a] font-medium mb-6">
                  Start building your barangay team directory
                </p>
                <button
                  @click="addPersonnel"
                ...
                >
                  <div class="bg-linear-to-r from-[#002147] to-[#004595] px-6 py-4">
                    ...
                    <p class="text-xs text-white/80 font-medium mt-1">
                      Click on a position to view and manage officers
                    </p>
                  </div>
                  ...
                  <div class="p-6 bg-linear-to-br from-[#f3f1ee]/20 to-white">
                    <div v-if="uniquePositions.length === 0" class="text-center py-12">
                      <div class="inline-block p-4 bg-[#004595]/5 rounded-2xl mb-3">
                        <svg
                          class="w-12 h-12 text-[#004595]/30"
                          fill="currentColor"
                          viewBox="0 0 20 20"
                        >
                          <path
                    ...
                    <div v-else class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                      ...
                      >
                        ...
                        <div
                          ...
                          @click="openPositionOfficersModal(position)"
                        >
                          ...
                          <h4
                            class="font-bold text-[#002147] text-lg mb-2 group-hover:text-[#004595] transition-colors line-clamp-2"
                          >
                            {{ position }}
                          </h4>
                          <p class="text-xs text-[#00397a] font-medium mb-4">
                            {{ officersByPosition[position]?.length || 0 }} officer{{
                              (officersByPosition[position]?.length || 0) !== 1 ? 's' : ''
                            }}
                            assigned
                          </p>

                          <div
                            class="flex items-center gap-2 text-xs font-semibold text-[#004595] group-hover:text-[#002147] transition-colors"
                          >
            ...
            <div v-if="activeTab === 'history'" id="history-section" class="space-y-6">
                ...
                >
                    ...
                    <div class="relative w-full h-112.5 flex items-center justify-center">
                      ...
                      >
                        <div class="flex items-center gap-2">
                          <svg
                            class="w-5 h-5 text-[#004595] group-hover/btn:text-[#002147] transition-colors"
                            fill="none"
                            stroke="currentColor"
                            viewBox="0 0 24 24"
                          >
                  ...
                  <div class="p-8 bg-linear-to-br from-white to-[#f3f1ee]/20">
                    ...
                    <div class="mb-6 pb-4 border-b-2 border-[#004595]/10">
                      ...
                      <h2 class="text-2xl font-bold text-[#002147] tracking-tight">
                        Community Details
                      </h2>
                    </div>
                    ...
                    <div class="space-y-5">
                      ...
                      >
                        ...
                        <div class="relative">
                          <div
                            class="flex items-center gap-4 mb-6 pb-4 border-b-2 border-[#004595]/20"
                          >
                            <div class="p-3 bg-[#004595]/10 rounded-xl">
                              <svg
                                class="w-7 h-7 text-[#004595]"
                                fill="currentColor"
                                viewBox="0 0 20 20"
                              >
                                <path
                            ...
                            <div>
                              <p class="text-sm font-bold text-[#00397a] uppercase tracking-wider">
                                Barangay History
                              </p>
                            </div>
                          </div>
              ...
              >
                ...
                <p class="text-[#00397a] font-medium">
                  Barangay information has not been added yet.
                </p>
                <div
                  class="mt-6 inline-flex items-center gap-2 px-4 py-2 bg-[#f3f1ee] rounded-lg text-sm text-[#00397a] font-semibold"
                >
                  <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                    <path
                      fill-rule="evenodd"
            ...
            <div v-if="activeTab === 'landmarks'" class="space-y-6">
                ...
                >
                  ...
                  <div class="p-6 relative">
                    <div class="flex flex-col items-center text-center mb-4">
                      ...
                      <h3
                        class="text-2xl font-bold text-[#002147] mb-1 group-hover:text-[#004595] transition-colors"
                      >
                        Schools
                      </h3>
                    </div>
                ...
                >
                  ...
                  <div class="p-6 relative">
                    <div class="flex flex-col items-center text-center mb-4">
                      ...
                      <h3
                        class="text-2xl font-bold text-[#002147] mb-1 group-hover:text-[#00397a] transition-colors"
                      >
                        Churches
                      </h3>
                    </div>
              ...
              <!-- Info Card -->
              <div
                class="bg-linear-to-br dark:to-white-800  rounded-xl p-5 border border-[#004595]/10 shadow-sm"
              >
                <div class="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p class="text-xs text-[#00397a] font-medium">
                      Click on any category card to view detailed information and location maps.
          ...
          <form @submit.prevent="submitPersonnel" class="p-4">
            <div class="space-y-3">
              ...
              <div class="flex justify-center mb-2">
                <div class="relative group">
                  <div
                    class="w-20 h-20 rounded-xl overflow-hidden border-2 border-[#004595]/20 shadow-md"
                  >
                    <img
              ...
              <p class="text-[9px] text-[#00397a] text-center -mt-1 mb-2">
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                ...
                <div>
                  <label class="block text-xs font-semibold text-[#002147] mb-1"
                    >Phone Number</label
                  >
                  <input
                ...
                <div>
                  <label class="block text-xs font-semibold text-[#002147] mb-1"
                    >Purok <span class="text-gray-400 text-[10px]">(Optional)</span></label
                  >
                  <input
                ...
                <div class="md:col-span-2">
                  ...
                  >
                    ...
                    <option v-if="positions.length === 0" value="" disabled>
                ...
                <div class="md:col-span-2">
                  <label class="block text-xs font-semibold text-[#002147] mb-1"
                    >Description <span class="text-gray-400 text-[10px]">(Optional)</span></label
                  >
                  <textarea
      ...
      >
        ...
        >
          ...
          <div class="relative flex items-center gap-3">
            ...
            >
              ...
              <div
                v-else
                class="w-full h-full flex items-center justify-center bg-white/20 backdrop-blur-sm"
              >
                <svg class="w-7 h-7 text-white" fill="currentColor" viewBox="0 0 20 20">
                  <path
                    fill-rule="evenodd"
            ...
            <div class="flex-1 min-w-0">
              ...
              <p class="text-white/90 text-xs font-semibold truncate">
        ...
        <div class="p-4 bg-linear-to-br from-[#f3f1ee]/30 to-white space-y-3">
          ...
          <div class="bg-white rounded-xl p-4 shadow-sm border border-[#004595]/10">
            <h4
              class="text-xs font-bold text-[#002147] uppercase tracking-wide mb-3 flex items-center gap-2"
            >
              <svg class="w-4 h-4 text-[#004595]" fill="currentColor" viewBox="0 0 20 20">
                <path
                  fill-rule="evenodd"
            ...
            <div class="space-y-2.5">
              <!-- Full Name -->
              <div class="p-2.5 bg-[#f3f1ee]/50 rounded-lg">
                <p class="text-[9px] text-[#00397a] font-bold uppercase tracking-wide mb-0.5">
                  Full Name
                </p>
                <p class="text-[#002147] font-semibold text-sm">{{ selectedPersonnel?.name }}</p>
              </div>
              ...
              <div class="flex items-center gap-2.5 p-2.5 bg-[#f3f1ee]/50 rounded-lg">
                ...
                <div class="flex-1 min-w-0">
                  <p class="text-[9px] text-[#00397a] font-bold uppercase tracking-wide">
                    Phone Number
                  </p>
                  <p class="text-[#002147] font-semibold text-sm truncate">
              ...
              <div class="p-2.5 bg-[#f3f1ee]/50 rounded-lg">
                <p class="text-[9px] text-[#00397a] font-bold uppercase tracking-wide mb-0.5">
                  Purok <span class="text-gray-400">(Optional)</span>
                </p>
                <p class="text-[#002147] font-semibold text-sm">
                  {{ selectedPersonnel?.purok_number || 'Not specified' }}
                </p>
              </div>
              ...
              <!-- Description -->
              <div v-if="selectedPersonnel?.description" class="p-2.5 bg-[#f3f1ee]/50 rounded-lg">
                <p class="text-[9px] text-[#00397a] font-bold uppercase tracking-wide mb-0.5">
                  Description <span class="text-gray-400">(Optional)</span>
                </p>
                <p class="text-[#002147] font-medium text-xs leading-relaxed">
    ...
    <div
      v-if="showPositionOfficersModal"
      class="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4"
      @click.self="closePositionOfficersModal"
    >
      <div
        class="bg-white rounded-2xl shadow-2xl w-full max-w-4xl overflow-hidden transform transition-all max-h-[90vh] flex flex-col"
      >
        <!-- Modal Header -->
        <div
          class="bg-linear-to-r from-[#002147] via-[#00397a] to-[#004595] px-6 py-5 relative overflow-hidden"
          ...
          <div class="relative flex items-center justify-between gap-4">
            <div class="flex items-center gap-3 flex-1">
              ...
              <div>
                ...
                <p class="text-xs text-white/80 font-medium mt-1">
                  {{ officersForSelectedPosition.length }} officer{{
                    officersForSelectedPosition.length !== 1 ? 's' : ''
                  }}
                  in this position
                </p>
              </div>
        ...
        <div class="flex-1 overflow-y-auto p-6 bg-linear-to-br from-[#f3f1ee]/30 to-white">
          <div v-if="officersForSelectedPosition.length === 0" class="text-center py-16">
            ...
            <p class="text-[#00397a] font-medium mb-6">
              Add officers to this position to get started
            </p>
            <button
              @click="addOfficerToPosition"
              class="inline-flex items-center gap-2 px-6 py-3 bg-linear-to-r from-[#002147] to-[#004595] text-white rounded-xl hover:shadow-xl hover:scale-105 transition-all duration-300 font-bold"
          ...
          <div v-else class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            >
              ...
              <div class="relative flex flex-col items-center text-center">
                <!-- Photo or Avatar -->
                <div
                  class="w-20 h-20 rounded-2xl overflow-hidden mb-4 shadow-lg ring-2 ring-[#004595]/20 group-hover:ring-4 group-hover:ring-[#004595]/40 transition-all"
                >
                  <img
                ...
                <h4
                  class="font-bold text-[#002147] text-base mb-2 group-hover:text-[#004595] transition-colors"
                >
                  {{ person.name }}
                </h4>
                ...
                <div
                  ...
                  class="text-[10px] text-[#00397a] mb-3 line-clamp-2 px-2"
                >
                  {{ person.description }}
                </div>
      ...
      >
        ...
        <div class="p-6">
          <div class="text-center mb-6">
            ...
            <div
              v-if="officersByPosition[positionToDelete]?.length > 0"
            ...
            >
              <p class="text-xs text-amber-800 font-semibold">
                ...
                {{ officersByPosition[positionToDelete].length }} officer{{
                  officersByPosition[positionToDelete].length !== 1 ? 's' : ''
                }}
      ...
      >
        ...
        >
          <div class="relative p-4">
            ...
            <div
              class="absolute top-0 right-0 w-32 h-32 bg-white/10 rounded-full blur-2xl -mr-16 -mt-16 animate-pulse"
            ></div>
            ...
            <div class="relative flex items-start gap-4">
              ...
              <div class="flex-1 pt-0.5">
                <p class="text-white font-bold text-base tracking-wide leading-snug">
                  {{ toast.message }}
                </p>
                <p v-if="toast.description" class="text-white/80 text-sm mt-1 font-medium">
                  {{ toast.description }}
                </p>
              </div>
    ...
    >
      ...
      >
          ...
          <div class="space-y-3">
            ...
            <div class="relative">
              ...
              >
                ...
                <span>{{
                  uploadingHistoryImage
                    ? 'Uploading...'
                    : historyForm.brgy_images
                      ? 'Change Image'
                      : 'Upload Image'
                }}</span>
              </button>
        ...
        <!-- Modal Footer -->
        <div
          class="px-6 py-4 bg-[#f3f1ee]/30 border-t border-[#004595]/10 flex gap-3 sticky bottom-0"
        >
          <button
            @click="closeHistoryModal"
  ...
  try {
    ...
    if (deletedCount > 0) {
      showToast(
        'Success!',
        'success',
        `Position "${positionToDelete.value}" and ${deletedCount} officer${deletedCount !== 1 ? 's' : ''} have been deleted`,
      )
    } else {
...
const handlePersonnelPhotoUpload = async (event) => {
  ...
  try {
    ...
    const { data: urlData } = supabase.storage.from('BrgyMember').getPublicUrl(filePath)
...
const submitPersonnel = async () => {
  ...
  try {
    ...
    showToast(
      'Operation Failed',
      'error',
      `Failed to ${isEditMode.value ? 'update' : 'add'} personnel. Please try again.`,
    )
  } finally {
...
const handleHistoryImageUpload = async (event) => {
  ...
  try {
    ...
    // Get public URL
    const { data: urlData } = supabase.storage.from('BarangayImages').getPublicUrl(filePath)
