  ...
  <div class="min-h-screen flex items-center justify-center relative overflow-hidden bg-gradient-to-br from-[#002147] to-[#00397a]">
    ...
    <Transition name="modal-fade">
      <div v-if="showSuccessModal" class="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
        <div class="success-modal bg-white rounded-2xl shadow-2xl max-w-md w-full p-8 transform animate-modal-slide">
          <!-- Success Icon -->
    ...
    <Transition name="modal-fade">
      <div v-if="showErrorModal" class="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
        <div class="error-modal bg-white rounded-2xl shadow-2xl max-w-md w-full p-8 transform animate-modal-slide">
          <!-- Error Icon -->
          <div class="flex justify-center mb-6">
    ...
    <div class="relative z-10 w-full max-w-5xl mx-auto px-4 flex items-center justify-center lg:justify-between gap-8">
      ...
      <div class="w-full max-w-md animate-fade-in-right">
        <div class="login-card bg-white/98 backdrop-blur-sm p-7 rounded-xl shadow-2xl border border-white/30 relative overflow-hidden">
          ...
          <!-- Top Accent Line -->
          <div class="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-transparent via-[#004595] to-transparent"></div>
          ...
          <form @submit.prevent="handleLogin" class="space-y-4 relative z-10">
            ...
            <div class="form-group">
              ...
              <div class="relative input-wrapper group">
                <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none z-10">
                  <div class="relative">
                    <svg class="w-5 h-5 text-[#00397a]/50 group-focus-within:text-[#004595] transition-colors" fill="currentColor" viewBox="0 0 20 20">
                      <path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z" />
                      <path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z" />
                    </svg>
                    <div class="absolute -top-1 -right-1 w-2 h-2 bg-[#004595] rounded-full opacity-0 group-focus-within:opacity-100 group-focus-within:animate-ping"></div>
                  </div>
                </div>
                <input
                  v-model="email"
                ...
                <div class="absolute inset-0 rounded-lg border-2 border-[#004595] opacity-0 group-focus-within:opacity-20 transition-opacity pointer-events-none animate-pulse-border"></div>
              </div>
            </div>
            ...
            <div class="flex items-center justify-start text-xs pt-1">
              <label class="flex items-center cursor-pointer group">
                <div class="relative">
                  <input type="checkbox" class="w-3.5 h-3.5 rounded border-2 border-[#00397a]/30 text-[#004595] focus:ring-2 focus:ring-[#004595]/20 cursor-pointer">
                  <div class="absolute inset-0 rounded border-2 border-[#004595] opacity-0 group-hover:opacity-30 transition-opacity pointer-events-none"></div>
                </div>
                <span class="ml-2 text-[#00397a]/80 group-hover:text-[#004595] transition-colors font-medium flex items-center gap-1">
                  Remember me
          ...
          <div class="mt-6 pt-5 border-t border-[#f3f1ee] relative z-10">
            ...
            <p class="text-center text-[10px] text-[#00397a]/50 mt-2 font-medium">BCPO & BXU Community Monitoring System</p>
          </div>
        </div>
      </div>
    </div>
