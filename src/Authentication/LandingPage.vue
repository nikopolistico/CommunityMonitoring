        ...
        <div class="relative z-[1] text-center max-w-[1100px] mx-auto px-4 animate-fadeInUp">
          <div class="flex justify-center items-center gap-16 mb-12 max-md:gap-6 max-sm:gap-3 animate-scaleIn">
            <div class="flex items-center justify-center">
              <img src="@/assets/BCPO 1 LOGO.png" alt="BCPS 1 Logo" class="h-[120px] w-[120px] object-contain max-md:h-[80px] max-md:w-[80px] hover:scale-110 transition-transform duration-300" />
            </div>
            <div class="flex items-center justify-center">
              <img src="@/assets/pnplogo.png" alt="PNP Logo" class="h-[120px] w-[120px] object-contain max-md:h-[80px] max-md:w-[80px] hover:scale-110 transition-transform duration-300" />
            </div>
            <div class="flex items-center justify-center">
...
>>>>>>> 584a996666ee7dcc0472164df0f2067255cc96dd
          ...
          <div class="bg-white/90 backdrop-blur-[10px] p-8 text-center border-2 border-[#004595] rounded-xl transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_12px_30px_rgba(0,69,149,0.25)] hover:bg-white hover:border-[#002147] animate-fadeInUp animation-delay-300">
            <div class="text-5xl font-extrabold text-[#004595] mb-3">24/7</div>
            <div class="text-sm font-semibold text-[#002147] uppercase tracking-[1px]">Monitoring</div>
          </div>
          <div class="bg-white/90 backdrop-blur-[10px] p-8 text-center border-2 border-[#004595] rounded-xl transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_12px_30px_rgba(0,69,149,0.25)] hover:bg-white hover:border-[#002147] animate-fadeInUp animation-delay-500">
            <div class="text-5xl font-extrabold text-[#004595] mb-3 animate-countUp">100%</div>
            <div class="text-sm font-semibold text-[#002147] uppercase tracking-[1px]">Coverage</div>
          </div>
        </div>
      </section>
...
>>>>>>> 584a996666ee7dcc0472164df0f2067255cc96dd
              ...
              <div>
                <h3 class="text-[1.35rem] font-bold text-white mb-3 tracking-[0.5px] [text-shadow:1px_1px_4px_rgba(0,0,0,0.3)]">Educational Institutions</h3>
                <p class="text-base text-[#f3f1ee] leading-[1.6] opacity-95">Monitoring and support for schools within our jurisdiction</p>
              </div>
            </div>
          </div>
...
>>>>>>> 584a996666ee7dcc0472164df0f2067255cc96dd
              ...
              <div>
                <h3 class="text-[1.35rem] font-bold text-white mb-3 tracking-[0.5px] [text-shadow:1px_1px_4px_rgba(0,0,0,0.3)]">Business Establishments</h3>
                <p class="text-base text-[#f3f1ee] leading-[1.6] opacity-95">Security coordination for commercial areas and businesses</p>
              </div>
            </div>
          </div>
...
>>>>>>> 584a996666ee7dcc0472164df0f2067255cc96dd
              ...
              <div>
                <h3 class="text-[1.35rem] font-bold text-white mb-3 tracking-[0.5px] [text-shadow:1px_1px_4px_rgba(0,0,0,0.3)]">Community Events</h3>
                <p class="text-base text-[#f3f1ee] leading-[1.6] opacity-95">Support for church activities and public gatherings</p>
              </div>
            </div>
          </div>
...
>>>>>>> 584a996666ee7dcc0472164df0f2067255cc96dd
              ...
              <div>
                <h3 class="text-[1.35rem] font-bold text-white mb-3 tracking-[0.5px] [text-shadow:1px_1px_4px_rgba(0,0,0,0.3)]">Rapid Response</h3>
                <p class="text-base text-[#f3f1ee] leading-[1.6] opacity-95">Quick deployment and emergency coordination</p>
              </div>
            </div>
          </div>
        </div>
...
<<<<<<< HEAD
        <div class="max-w-[1200px] mx-auto text-center">
          <div class="flex justify-center items-center gap-10 mb-4 max-md:gap-6 max-sm:gap-4">
            <div class="flex items-center justify-center">
              <img src="@/assets/BCPO 1 LOGO.png" alt="BCPS 1 Logo" class="h-[60px] w-[60px] object-contain max-md:h-[50px] max-md:w-[50px] hover:scale-110 transition-transform duration-300" />
            </div>
            <div class="flex items-center justify-center">
              <img src="@/assets/pnplogo.png" alt="PNP Logo" class="h-[60px] w-[60px] object-contain max-md:h-[50px] max-md:w-[50px] hover:scale-110 transition-transform duration-300" />
            </div>
            <div class="flex items-center justify-center">
...
>>>>>>> 584a996666ee7dcc0472164df0f2067255cc96dd
          ...
          <p class="text-[0.9rem] text-[#f3f1ee] opacity-90">Serving and Protecting the Community</p>
        </div>
      </footer>
...
.hero-container::before {
  ...
  position: absolute;
  inset: 0;
  background: linear-gradient(135deg, rgba(0, 33, 71, 0.7) 0%, rgba(0, 69, 149, 0.6) 100%);
  z-index: 0;
}
...
.info-section::before {
  ...
  position: absolute;
  inset: 0;
  background: linear-gradient(135deg, rgba(243, 241, 238, 0.85) 0%, rgba(255, 255, 255, 0.75) 100%);
  z-index: 0;
}
...
.services-section::before {
  ...
  position: absolute;
  inset: 0;
  background: linear-gradient(135deg, rgba(0, 33, 71, 0.8) 0%, rgba(0, 57, 122, 0.75) 100%);
  z-index: 0;
}
...
.service-card:hover {
  ...
  box-shadow: 0 12px 35px rgba(0, 69, 149, 0.5);
