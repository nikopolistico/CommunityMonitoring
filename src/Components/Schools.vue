	...
	<div class="min-h-screen bg-[#f3f1ee]">
		<div class="mx-auto max-w-7xl px-4 py-10 space-y-8">
			...
			<section v-if="communityInfo" class="space-y-6">
				<div class="rounded-2xl bg-linear-to-r from-[#002147] to-[#004595] p-8 shadow-2xl text-white">
					<p class="text-sm uppercase tracking-widest font-semibold opacity-80">Schools</p>
				...
				<div class="grid gap-5 md:grid-cols-2">
							...
							<div class="flex-1 space-y-2">
								<div v-if="editingId === item.id" class="space-y-2">
									...
									<div class="flex gap-2">
										<button
											type="button"
											class="inline-flex items-center gap-1 rounded-lg bg-[#004595] px-3 py-2 text-xs font-bold text-white hover:bg-white hover:text-[#004595] border-2 border-[#004595] transition"
											@click="saveEdit"
										>
											Save
										</button>
								...
								<p class="text-sm text-gray-600">{{ item.schoolAddress || 'Located in ' + communityInfo.name + ', Butuan City.' }}</p>
							</div>
						</div>
					</div>
					<div class="mt-4 flex flex-wrap justify-end gap-2">
						<button
							type="button"
							class="inline-flex items-center justify-center rounded-lg bg-white p-2 text-[#004595] border-2 border-[#004595] hover:bg-[#004595]/10 transition"
				...
				>
					<div class="w-full max-w-md rounded-2xl bg-white p-6 shadow-2xl space-y-4">
						...
						<div class="flex flex-wrap justify-end gap-2">
							<button
								type="button"
								class="inline-flex items-center gap-1 rounded-lg bg-white px-4 py-2 text-sm font-bold text-[#004595] border-2 border-[#004595] hover:bg-[#004595]/10 transition"
								@click="closeDelete"
							>
								Cancel
							</button>
