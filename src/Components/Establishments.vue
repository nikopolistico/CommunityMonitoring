  ...
  >
    <div class="mx-auto max-w-none px-6 py-10 space-y-8">
      ...
      <section v-if="communityInfo" class="space-y-6">
        ...
        >
          ...
          <div class="relative z-10">
            ...
            <p class="text-lg text-white/90 mt-2">
              Businesses and key establishments in this barangay.
            </p>
          </div>
          <div class="absolute top-0 right-0 p-2 sm:p-4 z-20">
            <button
              @click="viewMap"
              class="bg-white/20 hover:bg-white/30 cursor-pointer text-white px-2 py-1.5 sm:px-4 sm:py-2 rounded-lg text-xs sm:text-sm font-medium transition-colors flex items-center gap-1 sm:gap-2 pointer-events-auto"
            >
              <span class="hidden sm:inline">View Map</span>

              <svg
                class="w-5 h-5 sm:w-6 sm:h-6 md:w-8 md:h-8 shrink-0"
                viewBox="0 0 24 24"
                fill="none"
                stroke="currentColor"
                stroke-width="2"
        ...
        <div v-if="viewMode === 'cards'" class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            ...
            <p class="text-gray-600 font-medium">
              {{
                searchQuery
                  ...
                  : 'No establishments yet. Add one to get started!'
              }}
            </p>
          </div>
          ...
          >
            ...
            <div v-if="item.establishmentImages" class="w-full h-56 overflow-hidden bg-gray-50">
              <img
                :src="item.establishmentImages"
                :alt="item.establishmentName"
              ...
              <div v-if="false" class="space-y-3">
                ...
                <div class="flex flex-col items-center mb-3">
                  <div class="relative group">
                    <div
                      class="w-24 h-24 rounded-xl overflow-hidden border-2 border-[#004595]/20 shadow-md"
                    >
                      <img
              ...
              <div v-else class="space-y-3">
                ...
                <div class="space-y-1.5 text-sm text-gray-600">
                  ...
                  <div v-if="item.contactNumber" class="flex items-center gap-2">
                    <svg
                      class="w-4 h-4 text-[#004595] shrink-0"
                      fill="currentColor"
                      viewBox="0 0 20 20"
                    >
                      <path
                  ...
                  <div
                    ...
                    class="flex items-center gap-2 text-green-700 bg-green-50 px-2 py-1.5 rounded-lg border border-green-200"
                  >
                    <svg
              ...
              >
                <td class="px-6 py-4">
                  <div class="flex items-center gap-3">
                    ...
                    <div class="font-semibold text-[#002147]">
                      {{ item.establishmentName || 'N/A' }}
                    </div>
                  </div>
                </td>
                <td class="px-6 py-4">
            ...
            <form @submit.prevent="addItem" class="p-6">
              <div class="space-y-4">
                ...
                <div class="space-y-3">
                  ...
                  <div class="space-y-2">
                    ...
                    <div v-if="newLatitude && newLongitude" class="grid grid-cols-2 gap-2">
                      <div class="p-3 bg-green-50 border border-green-200 rounded-lg">
                        <p class="text-[10px] text-green-700 font-semibold uppercase tracking-wide">
                          Latitude
                        </p>
                  ...
                  <div>
                    <label class="block text-xs font-semibold text-[#002147] mb-1.5"
                      >Establishment Name <span class="text-red-500">*</span></label
                    >
                    <input
                      v-model="newName"
                      type="text"
            ...
            <div v-else class="p-6 space-y-6">
              ...
              <div class="rounded-xl overflow-hidden border-2 border-[#004595]/10">
                <div v-if="detailsItem?.establishmentImages" class="w-full bg-gray-50">
                  <img
                    :src="detailsItem.establishmentImages"
                    :alt="detailsItem.establishmentName"
                    class="w-full h-full object-contain"
                  />
                </div>
                <div
                  v-else
                  class="w-full h-40 bg-linear-to-br from-[#002147] via-[#00397a] to-[#004595] flex items-center justify-center relative overflow-hidden"
                >
                  <div
              ...
              <div class="space-y-4">
                ...
                <div class="grid gap-4 md:grid-cols-3">
                  ...
                  >
                    <div class="flex items-start gap-2">
                      <svg
                        class="w-5 h-5 text-[#004595] mt-0.5 shrink-0"
                        fill="currentColor"
                        viewBox="0 0 20 20"
                      >
                        <path
                      ...
                      <div class="flex-1 min-w-0">
                        <p class="text-xs uppercase tracking-wide text-[#004595]/70 font-semibold">
                          Address
                        </p>
                        <p class="text-sm font-medium text-[#002147] mt-0.5 wrap-break-words">
                          {{ detailsItem?.establishmentAddress || 'Not provided' }}
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  >
                    <div class="flex items-start gap-2">
                      <svg
                        class="w-5 h-5 text-[#004595] mt-0.5 fshrink-0"
                        fill="currentColor"
                        viewBox="0 0 20 20"
                      >
                        <path
                      ...
                      <div class="flex-1 min-w-0">
                        ...
                        <p class="text-sm font-medium text-[#002147] mt-0.5 wrap-break-words">
                          {{ detailsItem?.contactNumber || 'Not provided' }}
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  >
                    <div class="flex items-start gap-2">
                      ...
                      <div class="flex-1 min-w-0">
                        ...
                        <p class="text-sm font-medium text-[#002147] mt-0.5">
                ...
                <div
                  v-if="detailsItem?.latitude && detailsItem?.longitude"
                  class="rounded-xl border-2 border-green-200 bg-linear-to-br from-green-50 to-white p-4"
                >
                  <h4
                    class="text-sm font-bold text-green-800 uppercase tracking-wide mb-3 pb-2 border-b border-green-200 flex items-center gap-2"
                  >
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path
                        stroke-linecap="round"
                  ...
                  <div class="grid grid-cols-2 gap-3">
                    <div>
                      <p class="text-xs text-green-700 uppercase tracking-wide font-semibold">
                        Latitude
                      </p>
                ...
                <div class="grid gap-4 md:grid-cols-2">
                  <div class="rounded-xl border-2 border-[#004595]/10 bg-white p-4">
                    <h4
                      class="text-sm font-bold text-[#002147] uppercase tracking-wide mb-3 pb-2 border-b border-[#004595]/10"
                    >
                      Owner Details
                    </h4>
                    <div class="space-y-2 text-sm">
                      <div>
                        ...
                        <p class="font-semibold text-[#002147]">
                          {{ detailsItem?.ownerName || 'Not provided' }}
                        </p>
                      </div>
                      <div>
                        <p class="text-xs text-gray-500 uppercase tracking-wide">Contact Number</p>
                        <p class="font-medium text-gray-700">
                          {{ detailsItem?.ownerContact || 'Not provided' }}
                        </p>
                      </div>
                      <div>
                        <p class="text-xs text-gray-500 uppercase tracking-wide">Email</p>
                        <p class="font-medium text-gray-700 wrap-break-words">
                          {{ detailsItem?.ownerEmail || 'Not provided' }}
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="rounded-xl border-2 border-[#004595]/10 bg-white p-4">
                    ...
                    <div class="space-y-2 text-sm">
                      <div>
                        <p class="text-xs text-gray-500 uppercase tracking-wide">Full Name</p>
                        <p class="font-semibold text-[#002147]">
                          {{ detailsItem?.managerName || 'Not provided' }}
                        </p>
                      </div>
                      <div>
                        <p class="text-xs text-gray-500 uppercase tracking-wide">Contact Number</p>
                        <p class="font-medium text-gray-700">
                          {{ detailsItem?.managerContact || 'Not provided' }}
                        </p>
                      </div>
                      <div>
                        <p class="text-xs text-gray-500 uppercase tracking-wide">Email</p>
                        <p class="font-medium text-gray-700 wrap-break-words">
                          {{ detailsItem?.managerEmail || 'Not provided' }}
                        </p>
                      </div>
                    </div>
                  </div>
        ...
        >
          <div
            class="relative w-full max-w-6xl h-[85vh] rounded-2xl bg-white shadow-2xl overflow-hidden transform transition-all"
          >
            <!-- Modal Header -->
            <div
              class="bg-linear-to-r from-[#002147] to-[#00397a] px-6 py-4 flex items-center justify-between"
            >
              <div class="flex items-center gap-3">
                <div class="p-2 bg-white/20 rounded-lg">
                  <svg
                ...
                <div>
                  <h3 class="text-lg font-bold text-white">
                    {{ communityInfo?.name }} - Establishments Map
                  </h3>
...
const addItem = async () => {
  ...
  try {
    ...
    if (ownerName) {
      ...
      const { error: ownerError } = await supabase.from('EstablishmentOwner').insert([ownerPayload])
    ...
    showToast(
      'Add Failed',
      'error',
      error?.message || 'Failed to add establishment. Please try again.',
    )
  } finally {
    loading.value = false
    uploadingPhoto.value = false
  ...
  try {
    ...
    if (hasManagerFields) {
      ...
      if (managerRow) {
        ...
        const { error: managerInsertError } = await supabase.from('EstablishmentManager').insert([
          {
    ...
    if (hasOwnerFields) {
      ...
      if (ownerRow) {
        ...
        const { error: ownerInsertError } = await supabase.from('EstablishmentOwner').insert([
          {
            est_id: editingId.value,
            Ownerfullname: ownerName || null,
            OwnerNumber: ownerContact || null,
